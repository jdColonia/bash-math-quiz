...
# Script para problemas de resta
...
num1=$((RANDOM % MAX_NUM + MIN_NUM))
num2=$((RANDOM % MAX_NUM + MIN_NUM))

# Asegurar que el resultado sea positivo (minuendo > sustraendo)
...
echo -e "${BLUE}Problema de resta:${NORMAL}"
echo -e "${YELLOW}¿Cuánto es $num1 - $num2?${NORMAL}"
